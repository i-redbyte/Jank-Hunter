...
open class JankHunterVariantConfiguration @Inject constructor(objects: ObjectFactory) {
    ...
    internal val artTiAgentApproval: Property<Boolean> = objects.property(Boolean::class.java)
    ...
    fun resolve(
        ...
        return JankHunterResolvedConfiguration(
            ...
            releaseSafety = JankHunterResolvedReleaseSafety(
                ...
                allowArtTiAgent = resolveScalar("allowArtTiAgent", layers, false) {
                    it.artTiAgentApproval.orNull
                },

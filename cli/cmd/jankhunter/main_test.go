...
func TestInspectAndCompareWriteMathReports(t *testing.T) {
	...
	assertFileContains(t, filepath.Join(dir, "report-math.html"), "Математический анализ", "Качество данных", "Робастная статистика", "Точки изменения", "Сетевые циклы")
	...
	assertFileContains(t, filepath.Join(dir, "compare-math.html"), "Математический анализ сравнения", "Качество сравнения", "Робастная статистика", "Точки изменения", "Сетевые циклы")
}

...
Версия формата создаваемого журнала определяется текущей утилитой; сейчас это JHLOG `5.1.0`. CLI также читает `5.0.0`, но сравнивать измерения разных семантик как равнозначные нельзя. Android SDK и Gradle-плагин имеют версию `1.0.10`, CLI - `1.0.0`; для воспроизводимости дополнительно сохраняйте commit и параметры сборки.
